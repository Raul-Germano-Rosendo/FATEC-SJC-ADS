...
def papagaio(falando, hora):
  ...
  #return True if papagaio(True, hora < 7) or papagaio(True, hora >= 20)
   #           else False
...
def dez(a, b):
  ...
  #return a or b or a+b == 10
  #return if dez(a + b) == 10 or dez(a) == 10 or dez(b) == 10
...
def dista10(n):
  ...
  #return abs(n-100) <=10 or (n-100) <= 10
